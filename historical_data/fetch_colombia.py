...
output_dir = "historical_data/Colombia/PrimeraA"
os.makedirs(output_dir, exist_ok=True)

print("Iniciando a busca histórica da Colômbia...")

for year, season_id in seasons.items():
    print(f"\n--- Buscando Temporada {year} (SofaScore ID: {season_id}) ---")
    
    # Executa o fetcher
    cmd = ["python", "proxy_sofascore_fetcher.py", "--tournament", "11539", "--season", str(season_id)]
    subprocess.run(cmd)
...
print("\n🎉 Todas as temporadas da Colômbia foram baixadas com sucesso!")
