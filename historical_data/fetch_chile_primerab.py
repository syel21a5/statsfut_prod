...
output_dir = "historical_data/Chile/PrimeraB"
os.makedirs(output_dir, exist_ok=True)

print("Iniciando a busca histórica do Chile Primera B...")

for year, season_id in seasons.items():
    print(f"\n--- Buscando Temporada {year} (SofaScore ID: {season_id}) ---")
    
    cmd = ["python", "proxy_sofascore_fetcher.py", "--tournament", "1240", "--season", str(season_id)]
    subprocess.run(cmd)
...
print("\n🎉 Todas as 3 temporadas do Chile Primera B foram baixadas com sucesso!")
