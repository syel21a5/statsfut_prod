...
class Command(BaseCommand):
    help = 'WIPE OUT Australia matches for 2026 to fix duplication issues'

    def handle(self, *args, **options):
        self.stdout.write("INICIANDO LIMPEZA RADICAL DA AUSTRÁLIA...")
        ...
        try:
            ...
            count = matches.count()
            matches.delete()
            self.stdout.write(self.style.SUCCESS(f"✅ {count} partidas da Austrália 2026 foram APAGADAS."))
