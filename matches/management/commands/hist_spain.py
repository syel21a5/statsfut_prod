...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        league = League.objects.filter(name__icontains='La Liga', country__icontains='Espanha').first()
        if not league:
            self.stdout.write(self.style.ERROR("Liga 'La Liga' (Espanha) não encontrada no banco."))
            return
        ...
        self.stdout.write(self.style.SUCCESS("\n✅ Importação histórica da Espanha concluída!"))
