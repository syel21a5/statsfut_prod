...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # O SofaScore agrupa por rodadas (rounds). Vamos primeiro descobrir quantas rodadas tem.
        ...
        if not rounds_data or 'rounds' not in rounds_data:
            self.stdout.write(self.style.ERROR("Falha ao obter rodadas. Tentando o fallback."))
            return
