...
ODDS_API_TEAM_MAPPINGS = {
    ...
    # --- AUSTRIA ---
    # Nomes canônicos = os que o sofascore grava no banco (via GitHub Action).
    # O Odds API envia nomes diferentes, por isso mapeamos aqui.
    ...
    "Bolívar": "Botafogo", # OddsAPI mismatch for Botafogo? No, check name
    "Botafogo": "Botafogo",
