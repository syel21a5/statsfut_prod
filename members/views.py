...
def premium_dashboard(request):
    ...
    context = {
        ...
        'trixie_dnb_tickets': [t for t in active_tickets if t.ticket_type == 'Trixie' and t.strategy == 'TRIXIE_DNB'],
        'trixie_over_15_tickets': [t for t in active_tickets if t.ticket_type == 'Trixie' and t.strategy == 'TRIXIE_OVER_15'],
        'trixie_dc_safe_tickets': [t for t in active_tickets if t.ticket_type == 'Trixie' and t.strategy == 'TRIXIE_DC_SAFE'],
