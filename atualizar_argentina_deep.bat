...
%PYTHON_EXEC% manage.py deep_scrape_sofascore --league_id 22 --season_year 2026 %TOR_FLAG%

echo.
echo [2/4] Processando Temporada 2025...
%PYTHON_EXEC% manage.py deep_scrape_sofascore --league_id 22 --season_year 2025 %TOR_FLAG%

echo.
echo [3/4] Processando Temporada 2024...
%PYTHON_EXEC% manage.py deep_scrape_sofascore --league_id 22 --season_year 2024 %TOR_FLAG%

echo.
echo [4/4] Processando Temporada 2023...
%PYTHON_EXEC% manage.py deep_scrape_sofascore --league_id 22 --season_year 2023 %TOR_FLAG%
