...
python3 manage.py import_football_data --min_year 2026 >> "$LOG_FILE" 2>&1
...
if [ "$RUN_API" = true ]; then
    ...
    python3 manage.py update_live_matches >> "$LOG_FILE" 2>&1
else
